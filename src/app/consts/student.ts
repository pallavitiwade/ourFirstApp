...
import { Imusic } from "../models/posts";
import { Ianimal, Iapp, Ibands, Ibeverage, Icontinent, Idessert, Ifestival, Iflower, Igadget, Ihotel, Iinsect, Iisland, Ilandmark, Imineral, Imoon, Imounts, Iocean, Iprofession, Iriver, Ispice, Itool, Iunive, Ivehicle } from "../models/student";
import { Iplant } from "../models/student";

export var planets:Array<Iplant> = [
...
export var mountains:Array<Imounts>= [
  ...
  { mountainName: "Mount Fuji", heightMeters: 3776, locationContinent: "Asia", firstAscentYear: 1865, isVolcano: true }
];


export var universities:Array<Iunive> = [
...
export var animals:Array<Ianimal> = [
...
// 9. continents
export var continents:Array<Icontinent> = [
...
// 10. desserts
export var desserts:Array<Idessert> = [
...
// 11. oceans
export var oceans:Array<Iocean> = [
...
// 12. gadgets
export var gadgets:Array<Igadget> = [
...
// 13. landmarks
export var landmarks:Array<Ilandmark> = [
...
// 14. vehiclesModels
export var vehiclesModels:Array<Ivehicle> = [
...
// 15. professions
export var professions:Array<Iprofession> = [
...
// 16. beveragesMenu
export var beveragesMenu:Array<Ibeverage> = [
...
// 17. flowers
export var flowers:Array<Iflower> = [
...
// 18. hotels
export var hotels:Array<Ihotel> = [
...
// 19. islands
export var islands:Array<Iisland> = [
...
// 20. insects
export var insects:Array<Iinsect> = [
...
// 21. festivals
export var festivals:Array<Ifestival> = [
...
// 22. rivers
export var rivers:Array<Iriver> = [
...
// 23. spices
export var spices:Array<Ispice> = [
...
// 25. minerals
export var minerals:Array<Imineral> = [
...
// 26. planetsMoons
export var planetsMoons:Array<Imoon> = [
...
// 27. musicalBands
export var musicalBands:Array<Ibands> = [
