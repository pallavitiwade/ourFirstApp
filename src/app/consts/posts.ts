import { Ifamous, Imountain, Ispace, Iworld ,Iprehistoric, Imovie, Imusic, Itech, Iancient, Iboard, Ifestive, Iwonder} from "../models/posts";

export var spaceMissions:Array<Ispace> = [
...
export var worldCuisines:Array<Iworld> = [
 ...
 export var mountainRanges:Array<Imountain> = [
...
export var famousAuthors:Array<Ifamous> = [
 ...
 export var prehistoricAnimals:Array<Iprehistoric> = [
...
export var famousInventions:Array<Ifamous> = [
...
export var movieGenres:Array<Imovie> = [
...
export var musicalGenres:Array<Imusic> = [
...
export var techInnovations:Array<Itech> = [
...
export var famousRivers:Array<Ifamous> = [
...
export var ancientStructures:Array<Iancient> = [
...
export var boardGames:Array<Iboard> = [
...
export var musicalInstrumentsWorld:Array<Imusic> = [
...
export var festivalsWorld:Array<Ifestive> = [
...
export var wondersOfNature:Array<Iwonder> = [
